...
if(isset($_POST['submitted']))
{
   if($fgmembersite->Login())
   {
	 ...
	 {
	 $fgmembersite->RedirectToURL("../../admin/admin.php");
	 }
       
     else{
	 $fgmembersite->RedirectToURL("login-home_eng.php");
	 }
   }
}
...
<div class="dropdownmenu">
        <ul id="nav">
            ...
            <li><a href="#">My account</a>
                <div>
                    <ul>
                        <li><a href='register_eng.php'>Create account</a></li>
                        <li><a href='login_eng.php'>Log in</a></li>
